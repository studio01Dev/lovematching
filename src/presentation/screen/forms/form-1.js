    ...
    return (
        <div style={{ display: `${view}` }}>
            ...
            <div class="valign gap32 margin">
                ...
                <Select labelText='직장 유형' values={['전문직', '대기업', '중견기업', '중소기업/스타트업', '공무원', '자영업', '공기업', '연구소', '스타트업', '프리랜서', '외국계']} dataToForm={data => job(data)} defaultValue={userData.job} />
                ...
                <InputCheckbox displayNotMatter={false} labelText='스타일 (최대 2개 선택 가능)' values={['귀여움', '지적임', '듬직함', '평범함', '건강미', '청순함', '세련됨', '선한 인상']} dataToForm={data => style(data)} defaultValue={userData.style} />
            </div>
