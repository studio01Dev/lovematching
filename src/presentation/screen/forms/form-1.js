    ...
    return (
        <div style={{ display: `${view}` }}>
            ...
            <div class="valign gap32 margin">
                ...
                <Select inputRef={inputRef.academicCareer} labelText='최종 학력' values={['고졸 이하', '전문대', '4년제대학', '해외대학', '석사', '박사']} dataToForm={data => academicCareer(data)} defaultValue={userData.academicCareer} />
                <Select inputRef={inputRef.job} labelText='직장 유형' values={['전문직', '대기업', '중견기업', '중소기업/스타트업', '공무원', '자영업', '공기업', '연구소', '스타트업', '프리랜서', '외국계']} dataToForm={data => job(data)} defaultValue={userData.job} />
                ...
                <Select inputRef={inputRef.howWork} labelText='근무 형태' values={['주 5일', '교대근무', '기타']} dataToForm={data => howWork(data)} defaultValue={userData.howWork} />
                ...
                <Select inputRef={inputRef.bodyType} labelText='체형' values={['마름', '날씬', '보통', '통통', '근육질']} dataToForm={data => bodyType(data)} defaultValue={userData.bodyType} />
