    ...
    return (
        <div style={{ display: `${view}` }}>
            ...
            <div class="valign gap32 margin">
                ...
                <Select inputRef={inputRef.job} labelText='직장 유형' values={['전문직', '대기업', '중견기업', '중소기업/스타트업', '공무원', '자영업', '공기업', '연구소', '프리랜서', '외국계']} dataToForm={data => job(data)} defaultValue={userData.job} />
