    ...
    return (
        <div>
            ...
            <div class="valign gap32 margin">
                ...
                <Select labelText='음주 횟수' values={['주 4회 이상', '주 2~3회', '월 2~4회', '월 1회 이하', '마시지 않음']} dataToForm={data => drinkingFrequency(data)} defaultValue={userData.drinkingFrequency} />
                ...
                <Select labelText='종교' values={['무교', '기독교', '천주교', '불교', '기타(직접입력)']} dataToForm={data => religion(data)}  defaultValue={userData.religion}/>
