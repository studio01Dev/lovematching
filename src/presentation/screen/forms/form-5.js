                ...
                <div>
                    ...
                    <div class="valign gap12 margin40">
                        ...
                        <div class="valign gap32">
                            ...
                            <InputCheckbox displayNotMatter={'block'} labelText='직종' values={['전문직', '대기업', '중견기업', '중소기업/스타트업', '공무원', '자영업', '공기업', '연구소', '스타트업', '프리랜서', '외국계']} dataToForm={data => counterpartJob(data)} />
                            ...
                            <InputCheckbox displayNotMatter={'block'} labelText='키' values={['145~150', '151~155', '156~160', '161~165', '166~170', '171~175', '176~180', '181~185', '186~190']} dataToForm={data => counterpartHeight(data)} />
                            <InputCheckbox displayNotMatter={'block'} labelText='체형' values={['마름', '날씬', '보통', '통통', '근육질']} dataToForm={data => counterpartBodyType(data)} />
                            <InputCheckbox displayNotMatter={'block'} labelText='스타일' values={['귀여움', '지적임', '듬직함', '평범함', '건강미', '청순함', '세련됨', '선한 인상']} dataToForm={data => counterpartStyle(data)} />
                        </div>
                    </div>
                    <div class="valign gap12">
                        ...
                        <div class="valign gap32 margin">
                            ...
                            <InputCheckbox displayNotMatter={'block'} labelText='음주 횟수' values={['주 4회 이상', '주 2~3회', '월 2~4회', '월 1회 이하', '마시지 않음']} dataToForm={data => counterpartDrinkingFrequency(data)} />
