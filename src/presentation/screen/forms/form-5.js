                ...
                <div>
                    ...
                    <div class="valign gap12 margin40">
                        ...
                        <div class="valign gap32">
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartAge} labelText='나이' values={['20~25', '26~30', '31~35', '36~40']} dataToForm={data => counterpartAge(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartAcademic} labelText='학력' values={['고졸 이하', '전문대', '4년제대학', '해외 대학', '석사', '박사']} dataToForm={data => counterpartAcademic(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartJob} labelText='직종' values={['전문직', '보건/의료직(전문직 외)', '대기업', '중견기업', '중소기업/스타트업', '공무원', '자영업', '공기업', '연구소', '스타트업', '프리랜서', '외국계']} dataToForm={data => counterpartJob(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartIncome} labelText='연소득 (단위: 만 원)' values={['1,001~2,000', '2,001~3,000', '3,001~4,000', '4,001~5,000', '5,001~6,000', '6,001~7,000', '7,001~8,000', '8,001 이상']} dataToForm={data => counterpartIncome(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartHowWork} labelText='근무 형태' values={['주 5일', '교대근무']} dataToForm={data => counterpartHowWork(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartHeight} labelText='키' values={['145~150', '151~155', '156~160', '161~165', '166~170', '171~175', '176~180', '181~185', '186~190']} dataToForm={data => counterpartHeight(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartBodyType} labelText='체형' values={['마름', '날씬', '보통', '통통', '근육질']} dataToForm={data => counterpartBodyType(data)} />
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartStyle} labelText='스타일' values={['귀여움', '지적임', '듬직함', '평범함', '건강미', '청순함', '세련됨', '선한 인상']} dataToForm={data => counterpartStyle(data)} />
                    ...
                    <div class="valign gap12">
                        ...
                        <div class="valign gap32 margin">
                            ...
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartDrinkingFrequency} labelText='음주 횟수' values={['주 4회 이상', '주 2~3회', '월 2~4회', '월 1회 이하', '마시지 않음']} dataToForm={data => counterpartDrinkingFrequency(data)} />
                            ...
                            <InputCheckbox  inputRef={inputRef.counterpartReligion} displayNotMatter={'block'} labelText='종교' values={['무교', '기독교', '천주교', '불교', '기타']} dataToForm={data => counterpartReligion(data)} />
