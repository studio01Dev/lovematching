                ...
                <div>
                    ...
                    <div class="valign gap12 margin40">
                        ...
                        <div class="valign gap32">
                            ...
                            <InputCheckbox displayNotMatter={'block'} inputRef={inputRef.counterpartJob} labelText='직종' values={['전문직', '보건/의료직(전문직 외)', '대기업', '중견기업', '중소기업/스타트업', '공무원', '자영업', '공기업', '연구소', '프리랜서', '외국계']} dataToForm={data => counterpartJob(data)} />
